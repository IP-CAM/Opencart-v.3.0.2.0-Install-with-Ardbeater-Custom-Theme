...
class ModelCatalogProduct extends Model {
	...
	public function editProduct($product_id, $data) {
		...
		if($this->config->get('module_notify_me_status')){
			if(isset($data['old_quantity']) && ($data['quantity'] > $data['old_quantity']) && ($data['old_quantity'] <= 0)){
				$this->load->model('extension/module/notify_me');
				$this->model_extension_module_notify_me->send_in_stock_email($product_id, $data);
			}
		}
