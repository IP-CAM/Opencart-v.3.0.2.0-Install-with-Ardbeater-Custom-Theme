...
/* __string_template__c92af4fffac63b14bf6b195c3fdbaa58c2ea81328593da7812ec8be83dc85ef6 */
class __TwigTemplate_5ae9bc3b91d1db768677c5bebe7734b9bd22b75e1256abdce9617e30156eb6df extends Twig_Template
{
...
\t\t\t\thtml += '        <h3 class=\"modal-title\"><i class=\"fa fa-plane\" style=\"font-size:14px\"></i> <strong>";
        // line 79
...
";
    ...
    {
        return "__string_template__c92af4fffac63b14bf6b195c3fdbaa58c2ea81328593da7812ec8be83dc85ef6";
    }
...
/* 				html += '      <div class="modal-header">';*/
/* 				html += '		 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>';*/
/* 				html += '        <h3 class="modal-title"><i class="fa fa-plane" style="font-size:14px"></i> <strong>{{ text_ongkir_method }}</strong></h3>';*/
/* 				html += '      </div><hr class="gradient-divider"></hr>';*/
/* 				html += '      <div class="modal-body">';*/
/* */
/* 				for (i in json['shipping_method']) {*/
