...
/* ardbeater/template/extension/payment/snapio.twig */
class __TwigTemplate_33a5d19f8ced4d8c5bb6432856688e8b519444e0352f00c48d78bc797d44daab extends Twig_Template
{
...
";
            // line 8
            if (((isset($context["pay_type"]) ? $context["pay_type"] : null) == "snapio")) {
                // line 9
                echo "  
  ";
                // line 10
    ...
    \$.ajax({
      ...
      success: function(data) {
        ...
        if ( ";
                ...
                echo (isset($context["disable_mixpanel"]) ? $context["disable_mixpanel"] : null);
                echo " === 0 ) {
          trackResult(data, merch_id, 'oc3_installment_offline', 'pay', null);
        }
        ...
        snap.pay(data, {
          ...
          onSuccess: function(result){
            if ( ";
                ...
                echo (isset($context["disable_mixpanel"]) ? $context["disable_mixpanel"] : null);
                echo " === 0 ) {
              trackResult(data, merch_id, 'oc3_installment_offline', 'success', result);
            }
          ...
          onPending: function(result){
            if ( ";
                ...
                echo (isset($context["disable_mixpanel"]) ? $context["disable_mixpanel"] : null);
                echo " === 0 ) {
              trackResult(data, merch_id, 'oc3_installment_offline', 'pending', result);
            }
          ...
          onError: function(result){
            if ( ";
                ...
                echo (isset($context["disable_mixpanel"]) ? $context["disable_mixpanel"] : null);
                echo " === 0 ) {
              trackResult(data, merch_id, 'oc3_installment_offline', 'error',result);
            }
          ...
          onClose: function(){
            if ( ";
                ...
                echo (isset($context["disable_mixpanel"]) ? $context["disable_mixpanel"] : null);
                echo " === 0 ) {
              trackResult(data, merch_id, 'oc3_installment_offline', 'close');
            }
  ...
  ";
    ...
    {
        return "ardbeater/template/extension/payment/snapio.twig";
    }
