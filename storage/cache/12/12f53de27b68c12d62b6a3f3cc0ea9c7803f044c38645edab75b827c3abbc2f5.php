...
/* __string_template__ab1634eca91a127a1d70c8d9e76c28ed91a3b7929102ff33c4155db256d67369 */
class __TwigTemplate_327dda301c65f7eca26e0bd7703de4a5d4e7344d10fe341c3f29ed59a9c9d799 extends Twig_Template
{
...
\t\t\t\thtml += '        <h3 class=\"modal-title\"><i class=\"fa fa-plane\"></i> <strong>";
        // line 79
...
";
    ...
    {
        return "__string_template__ab1634eca91a127a1d70c8d9e76c28ed91a3b7929102ff33c4155db256d67369";
    }
...
/* 				html += '      <div class="modal-header">';*/
/* 				html += '		 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>';*/
/* 				html += '        <h3 class="modal-title"><i class="fa fa-plane"></i> <strong>{{ text_ongkir_method }}</strong></h3>';*/
/* 				html += '      </div><hr class="gradient-divider"></hr>';*/
/* 				html += '      <div class="modal-body">';*/
/* */
/* 				for (i in json['shipping_method']) {*/
