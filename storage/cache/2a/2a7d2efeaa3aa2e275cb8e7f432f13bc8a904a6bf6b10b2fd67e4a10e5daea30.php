...
/* __string_template__200e0c5f3aaa1f3da8f0d8eb12a091315c313b0dfa96068da9e1f2e19ae49b60 */
class __TwigTemplate_7c6f327dd762116c92dd0cf3e5ef5942353b036cb334293759a7c0a799f749c8 extends Twig_Template
{
  ...
  <div class=\"heading-left\"><h3>";
    ...
    <div class=\"panel-body\">
      ...
      \t\t<p style=\"margin-left:16px\"><a style=\"color:red\">*</a> ";
        ...
        echo "\" class=\"btn btn-default\" style=\"float:right\">";
...
";
    ...
    {
        return "__string_template__200e0c5f3aaa1f3da8f0d8eb12a091315c313b0dfa96068da9e1f2e19ae49b60";
    }
...
/*           </div>*/
/*         </div>*/
/*         <button type="button" id="button-quote" data-loading-text="{{ text_loading }}" class="btn btn-default" style="float:right">{{ button_quote }}</button>*/
/*       </div>*/
/*       <script type="text/javascript"><!--*/
/* $('#button-quote').on('click', function() {*/
/* 	$.ajax({*/
...
/* 				html += '      <div class="modal-header">';*/
/* 				html += '		 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>';*/
/* 				html += '        <h3 class="modal-title">&#128666; {{ text_ongkir_method }}</h3>';*/
/* 				html += '      </div><hr class="gradient-divider"></hr>';*/
/* 				html += '      <div class="modal-body">';*/
/* */
/* 				for (i in json['shipping_method']) {*/
