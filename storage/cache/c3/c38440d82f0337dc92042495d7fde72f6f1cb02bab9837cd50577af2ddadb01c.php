...
/* __string_template__772e34eaa7e8ebfb5863a0daffdbd100dd782fbbfd61d88cb769a23b925de57b */
class __TwigTemplate_830feb7ab512d5caf3986edba421076368ce892d9576a4a2b702549fd78d9ce4 extends Twig_Template
{
  ...
  <div class=\"heading-left\"><h3>";
    ...
    <div class=\"panel-body\">
      ...
      \t\t<p style=\"margin-left:16px\"><a style=\"color:red\">*</a> E-Mail Address</p>
        ...
        echo "\" class=\"btn btn-default\"  style=\"float:right\">View Order</button>
      </div>
...
//--></script>
    ...
    {
        return "__string_template__772e34eaa7e8ebfb5863a0daffdbd100dd782fbbfd61d88cb769a23b925de57b";
    }
...
/*           </div>*/
/*         </div>*/
/*         <button type="button" id="button-order" data-loading-text="{{ text_loading }}" class="btn btn-default"  style="float:right">View Order</button>*/
/*       </div>*/
/*       <script type="text/javascript"><!--*/
/* $('#button-order').on('click', function() {*/
/* 	$.ajax({*/
