...
/* __string_template__861b22c25ad666ffbfc9677c8bea2f56fadf8077c8d1f72c7f1d75a219c2869a */
class __TwigTemplate_a0eb3a841a6d12f324a2f4dd971eca8af1708e7e2b53ed739caa5a27ae0fa22c extends Twig_Template
{
  ...
  <div id=\"notify_me\" class=\"modal fade\">
    <div class=\"modal-dialog\">
      <div class=\"modal-content\">
        ...
        echo "</h3>
        </div><hr class=\"gradient-divider\"></hr>
        ...
        echo "\" class=\"btn btn-default\"><i class=\"fa fa-paper-plane\"></i> ";
...
";
    ...
    {
        return "__string_template__861b22c25ad666ffbfc9677c8bea2f56fadf8077c8d1f72c7f1d75a219c2869a";
    }
...
/*         <div class="modal-header">*/
/*           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>*/
/*           <h3 class="modal-title">&#128276; {{notify_heading}}</h3>*/
/*         </div><hr class="gradient-divider"></hr>*/
/*         <div class="modal-body">*/
/*           <form id="notify_me" onclick="return false;">*/
/*             <input type="hidden" name="product_id" value="" id="product_id">*/
...
/*             </div>*/
/*             <div class="form-group">*/
/*               <button type="button" id="submit"  data-loading-text="{{ text_loading }}" class="btn btn-default"><i class="fa fa-paper-plane"></i> {{button_notify_send}}</button>*/
/*             </div>*/
/*           </form>*/
/*         </div>*/
/*       </div>*/
