...
class SingleSignOn_Broker
{
     ...
     * @var string
     */
    public $url = "http://localhost/sso/server/sso.php";
    
    /**
     * My identifier, given by SSO provider.
     * @var string
     */
    public $broker = "ARDBEATER";

    /**
     * My secret word, given by SSO provider.
     * @var string
     */
    public $secret = "skckwkyk123";
    ...
    {
        list($ret, $body) = $this->serverCmd('login', array('email'=>$email, 'password'=>$password));
